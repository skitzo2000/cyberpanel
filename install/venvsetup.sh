...
wget -O requirements.txt https://raw.githubusercontent.com/skitzo2000/cyberpanel/1.8.0/requirments.txt
...
if [[ $DEV == "ON" ]] ; then
	...
	source /usr/local/CyberPanel/bin/activate
	wget -O requirements.txt https://raw.githubusercontent.com/skitzo2000/cyberpanel/$BRANCH_NAME/requirments.txt
...
if [[ $SERVER_COUNTRY == "CN" ]] ; then
	...
	if [[ $DEV == "ON" ]] ; then
	git clone https://github.com/skitzo2000/cyberpanel
	cd cyberpanel
